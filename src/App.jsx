...
function App() {
  ...
  return (
    <div className="page">
      ...
      <header className="top-nav">
        <div className="top-nav-inner">
          ...
          <div className="nav-right">
            ...
            <div className="nav-meta" aria-label="站点状态">
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-friends" aria-label="友链">
            ...
            <span className="footer-friends-sep" aria-hidden="true">·</span>
            <a
              className="footer-friend-link"
      ...
      {/* 右侧悬浮：学习打卡 */}
      <div className="floating-checkin" aria-label="学习打卡">
        {user ? (
          <button
            type="button"
          ...
          <a
            className="floating-checkin-btn"
            href="/api/auth/github/start?next=/?page=checkin"
          >
            <span>学习打卡</span>
